...
export const Login = () => {
    ...
    return register ? <Register 
                        signup={signup} waiting={waiting} firebaseLogin={firebaseLogin}
        ...
        <div className = " d-flex justify-content-center mh-100">
            <form name = 'login'>
                ...
                <div className = "form-floating mb-3">
                    <input 
                        name = "name" type = "text" className = "form-control" id = "floatingInput" onChange = {handleInputChange} 
                    />
                ...
                <div className = "container my-5">
                    <button disabled = {waiting} className = "row w-100 btn btn-primary btn-dark my-1" onClick = {checkForm}>
                        Login
                    </button>

                    <button disabled = {waiting} className = "row w-100 btn btn-primary btn-dark my-1" onClick = {googleSignIn}>
                        Login con cuenta de Google
                    </button>
                </div>
                
                <button className="btn link-secondary mb-5 btn-dark text-info" onClick={signup}>
                    Registrarse
                </button>
            </form>
        </div>
